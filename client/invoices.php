...
$sql="select distinct tblclient.ContactName,tblclient.CompanyName,tblinvoice.BillingId,tblinvoice.PostingDate,tblinvoice.payment_status from  tblclient   
									      ...
									      <th scope="row"><?php echo htmlentities($cnt);?></th>
									       ...
									       <td><?php  echo htmlentities($row->CompanyName);?></td>
											...
											<?php if ($row->payment_status != 'paid') { ?>
												<td><a href="payment.php?invoiceid=<?php echo $row->BillingId; ?>">Pay</a></td>
											<?php } else { ?>
												<td>Already Paid</td>
											<?php } ?>
									     </tr>
